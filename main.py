...
async def command_start(message: Message):
    await message.answer('Привет! Здесь ты найдешь обои на любой вкус!!!')
...
async def show_categories(message: Message):
    ...
    # categories = WalpapersDB.get_all_categories()
...
@You_favorite_wallpapersBot''', reply_markup=download_button(image_id))
